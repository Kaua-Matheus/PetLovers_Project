export default function Product_lg({Name, Description, Price, Image}){
    return (
        <div class=''>
            <div class='flex flex-row flex-wrap justify-center items-center'>
                <div class='flex-initial flex-col items-center'>
                    <img src='https://via.placeholder.com/150' alt='Imagem do produto' class='rounded-lg p-2 object-cover h-48'/>
