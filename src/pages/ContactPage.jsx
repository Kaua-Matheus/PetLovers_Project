...
export default function ContactPage() {
    ...
    return (
        ...
        <main className='mx-32 p-5'>
            ...
            <div className="mt-20 py-2 space-y-2">
                <div className="flex h-[24rem] space-x-2 justify-center">
                    <FullscreenImage src={dog} alt="Dog"/>
                <div className="space-y-2">
                    <FullscreenImage css='h-[10rem]' src={dog} alt="Dog"/>
                    <FullscreenImage css='h-[13.5rem]' src={dog} alt="Dog"/>
                </div>
                <div className="space-y-2">
                    <FullscreenImage css='h-[24rem]' src={dog} alt="Dog"/>
                </div>
                </div>
                <FullscreenImage css='w-screen h-[10rem]' src={dog} alt="Dog"/>
            </div>
